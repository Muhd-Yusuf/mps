...
const BREVO_SENDER_NAME = process.env.BREVO_SENDER_NAME || "MPS Media Poetry Challenge"
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 20px; color: #4a4a4a; font-size: 16px; line-height: 1.6;">
                Your payment has been successfully processed. Below is your unique voting code that you can use to cast your vote.
              </p>
              ...
              <ul style="margin: 0 0 30px; padding-left: 20px; color: #4a4a4a; font-size: 16px; line-height: 1.8;">
                ...
                <li style="margin-bottom: 10px;">Cast your vote for your favorite poet</li>
              </ul>
...
export function createVotingCodeEmailText(votingCode: string, appUrl?: string): string {
  ...
  return `
MPS Media Poetry Challenge - Your Voting Code
...
- Cast your vote for your favorite poet
